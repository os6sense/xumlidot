= RUML-X-MIDOT Ruby UML XMI & DOT generator
...
To overcome this we parse the files into s-expressions via the absolutely awesome ruby parser and use
...
TODO: Include Xamin copyright disclaimer (parts copyright) in READM)
